...
if reload:
    ...
    g2_ = Get_dOmGW_dlnv(
        ...
        Use_S2 = Use_S2,
        ncpu = 12)
    np.savez('data/OmGW_1610_08275.npz', g1_ = g1_, g2_ = g2_)
    PyLab.Timer(t1)

r = np.load('data/OmGW_1610_08275.npz')
g1_ = r['g1_']
g2_ = r['g2_']
...
x1 = np.interp(x = 1, xp = np.log10(v1), fp = g1)
x2 = np.interp(x = 1, xp = np.log10(v), fp = g1_)
dif = x1/x2
print(dif)
#plt.show()
