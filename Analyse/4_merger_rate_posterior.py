...
ResultFile='/Users/cangtao/cloud/GitHub/NANOGrav-SIGW/LaTex/figs/Merger_rate_posteriors_01.pdf'

v = np.logspace(0, 10, 80)
LineWidth = 2
FontSize = 18
nm = 100
S_Tab_Len = 200
...
if reload:
    ...
    r0 = model(params)
    np.savez('data/4_merger_rate_posterior.npz', r = r, r0 = r0, r2 = r2)
    PyLab.Timer(t1)

R = np.load('data/4_merger_rate_posterior.npz')
r = R['r']
r0 = R['r0']
r2 = R['r2']
